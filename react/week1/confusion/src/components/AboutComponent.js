...
function RenderLeaders( { leaders } ) {
  ...
  const leadersList = leaders.map( leader => {
    return(
      <Media key={leader.id} className="row mb-4">
       <Media left href="#" className="col-3 col-md-3">
         <Media object src={leader.image} alt="alberto" />
       </Media>
       <Media body className="col-12 col-md-9 mt-0">
         <Media heading className="mt-0 mb-3">
           {leader.name}
         </Media>
